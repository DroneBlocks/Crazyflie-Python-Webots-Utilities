...
"""
Class has been adapted from the bitcraze pid_controller.py to be a base class for all pid controlled Robots, like the crazyfly
...
class PIDController():
    ...
    def pid(self, dt, desired_vx, desired_vy, desired_yaw_rate, desired_altitude, actual_roll, actual_pitch, actual_yaw_rate,
            actual_altitude, actual_vx, actual_vy) -> list[int | float | Any]:
        """
        :param dt: The time interval between updates of the PID controller.
        :param desired_vx: The desired velocity in the x-axis.
        :param desired_vy: The desired velocity in the y-axis.
        :param desired_yaw_rate: The desired yaw rate.
        :param desired_altitude: The desired altitude.
        :param actual_roll: The actual roll angle.
        :param actual_pitch: The actual pitch angle.
        :param actual_yaw_rate: The actual yaw rate.
        :param actual_altitude: The actual altitude.
        :param actual_vx: The actual velocity in the x-axis.
        :param actual_vy: The actual velocity in the y-axis.
        :return: A list of motor commands [m1, m2, m3, m4].
